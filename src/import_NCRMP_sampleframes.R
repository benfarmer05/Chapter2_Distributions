...
# 
# #retrieve files directly (already housed in package)
# STTSTJ_field_sites = NCRMP_STTSTJ_2013_21_percent_cover_site
# STTSTJ_field_species = NCRMP_STTSTJ_2013_21_percent_cover_species
# STTSTJ_field_sites$YEAR = as.factor(STTSTJ_field_sites$YEAR)
# levels(STTSTJ_field_sites$YEAR)
# 
# PR_field_sites = NCRMP_PRICO_2014_21_percent_cover_site
# PR_field_sites$YEAR = as.factor(PR_field_sites$YEAR)
# levels(PR_field_sites$YEAR)
# 
# STX_field_sites = NCRMP_STX_2015_19_percent_cover_site
# STX_field_sites$YEAR = as.factor(STX_field_sites$YEAR)
# levels(STX_field_sites$YEAR)
# 
# STTSTJ_grid = STTSTJ_2021_sample_frame_WGS1984
# PRICO_grid = PRICO_2021_sample_frame_WGS1984
# STX_grid = STX_2021_sample_frame_WGS1984
# 
# # 'fortify' the data to get a dataframe format required by ggplot2 and other sundry packages
# df.STTSTJ_grid = fortify(STTSTJ_grid)
